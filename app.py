...
<div class="nl-hero">
  ...
  <div class="nl-sub">Train your custom Vector → Matrix → Layer → Weight → Model stack, then inspect the actual math inside it.</div>
</div>
...
def load_dataset(name):
    ...
    return X, y, list(bunch.feature_names), list(bunch.target_names)
